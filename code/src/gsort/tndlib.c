...
long tnd_getnf_(char *path);
long tnd_read_(char *path, long *current, char *buff);
long tnd_decode_(unsigned short int *buff, long *nwords,  long *npar);


long tnd_getnf_(char *path){

 struct stat filestatus;
 long i,count,nfiles,isfirst=0;
 char *stri;
